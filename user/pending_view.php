...
<!--here showing results in the table -->
            ...
            <td><?php echo $edu;  ?></td>
            <td><button class="btn btn-danger" data-toggle="modal" data-target=".bs-example">Cancel</button></td> <!--btn btn-danger is a bootstrap button to show danger-->
        </tr>
        <div class="modal fade bs-example" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        	<div class="modal-dialog" role="document">
        		<div class="  modal-content">
        			<h4 class="modal-title" id="myModalLabel">Do you really want to unsubscribe?</h4>
        			<div class="modal-footer">
        				<button type="button" class="btn btn-default" data-dismiss="modal">NO</button>
        				<a href="cancel_pendency.php?cal=<?php echo $code ?>"><button type="button" class="btn btn-primary">YES</button></a>
        			</div>	
        			</div>
        		</div>
        	</div>
